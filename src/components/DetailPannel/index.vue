<template>
	<div class="detail-pannel" :style="{ height: height + 'px', width: width + 'px' }">
		<div class="detail-pannel-title">{{ title }}</div>
		<div class="detail-pannel-wrap" :style="{ height: height - 40 + 'px', width: width + 'px' }">
			<slot></slot>
		</div>
	</div>
</template>
