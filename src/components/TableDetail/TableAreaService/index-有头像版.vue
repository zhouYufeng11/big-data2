<template>
	<div class="detail-table">
		...
		<div class="bth-group">
			<button :class="['next', {disabled: isNextDisabled}]" :disabled="isNextDisabled" @click="nextDay">&lt;&lt;</button>
		...
		<div class="detail-table-container">
			<div class="table-item">
				<div class="police-title">局领导</div>
				<div class="police">
			...
			<div class="table-item">
				<div class="police-title">指挥长</div>
				<div class="police">
					<div class="police-item">
			...
			<div class="table-item">
				<div class="police-title">综合管理</div>
				<div class="police">
					<div class="police-item">
			...
			<div class="table-item">
				<div class="police-title">情报中心</div>
				<div class="police">
					<div class="police-item">
			...
			<div class="table-item">
				<div class="police-title">研判支撑</div>
				<div class="police">
					<div class="police-item">
			...
			<div class="table-item">
				<div class="police-title">舆情处置</div>
				<div class="police">
					<div class="police-item">
			...
			<div class="table-item">
				<div class="police-title">基础管控</div>
				<div class="police">
					<div class="police-item">
			...
			<div class="table-item">
				<div class="police-title">视频研判</div>
				<div class="police">
					<div class="police-item">
			...
			<div class="table-item">
				<div class="police-title">执法指导</div>
				<div class="police">
					<div class="police-item">
			...
			<div class="table-item">
				<div class="police-title">科技保障</div>
				<div class="police">
					<div class="police-item">
